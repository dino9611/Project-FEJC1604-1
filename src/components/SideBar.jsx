      ...
      <div>
        <div className="row p-0 m-0">
          ...
          <div className="col-md-10 m-0">
            ...
            <div className="row pt-3 pl-5 mt-1">
              <div className="col-md-2 font2">
                <div className="mt-3 d-flex">
                  ...
                  <Link
                    className="pl-2 link"
                    style={{
                      color: this.props.page === "profile" ? "black" : "gray",
                    }}
                    to="/userprofile"
                  >
                    Edit Profile
                ...
                <div className="mt-3 d-flex">
                  ...
                  <Link
                    className="pl-2 link"
                    style={{
                      color: this.props.page === "address" ? "black" : "gray",
                    }}
                    to="/address"
                  >
                    Address
                ...
                <div className="mt-3 d-flex">
                  ...
                  <Link
                    className="pl-3 link"
                    style={{
                      color: this.props.page === "security" ? "black" : "gray",
                    }}
                    to="/security"
                  >
                    Security
              ...
              <div className="col-md-7 pl-5 ">{this.props.children}</div>
            </div>
          </div>
        </div>
      </div>
